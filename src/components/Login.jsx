  ...
  return (
    <div className=" justify-start items-center flex-col h-screen ">
      <div className='grid grid-cols-2 gap-3 h-screen'>
        ...
        <div className="relative w-full h-full justify-center mt-5 items-center top-0 right-0 left-0 bottom-0">
            <div className="mt-20  ml-20 mr-0 mb-0 p-5">
              <img src={logo} width="360px" />
              
            </div>
            <div className="m-5 mt-0 text-2xl font-body text-black text-center subpixel-antialiased">
